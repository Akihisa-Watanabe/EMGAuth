...
import optuna
import pandas as pd
from experiment_tools import augumentation, feature_extractor, leaked_test_split
...
logger = logging.getLogger("leaked_test")
logger.setLevel(logging.DEBUG)
handler = logging.FileHandler("./leaked_test.log")
...
def train_and_test(args):
    ...
    X_train, y_train, X_test, y_test = leaked_test_split(
    ...
    rfc = RandomForestClassifier(
        min_samples_split=best_params["min_samples_split"], criterion=best_params["criterion"]
    )
